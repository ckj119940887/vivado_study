...
set rc [catch {
  ...
  add_files -quiet /home/ckj/git_dir/vivado_study/proj1.runs/synth_1/system.dcp
  ...
  set_param project.isImplRun false
  write_hwdef -force -file system.hwdef
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file system_timing_summary_routed.rpt -rpx system_timing_summary_routed.rpx -warn_on_violation "
